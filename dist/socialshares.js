/*! socialshares v2.0.0 - https://socialshar.es */
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _socialshares = __webpack_require__(35);
	...
	socialshares.configure = function (config) {
	  (0, _lodash2.default)(socialshares.config, config);
	};
	...
	socialshares.mount = function () {
	  ...
	  var buttons = document.querySelectorAll('.socialshares');
	  ...
	  try {
	    var _loop = function _loop() {
	      ...
	      var icononly = btnSet.getAttribute('data-icononly') === '' || socialshares.config.icononly;
	      ...
	      try {
	        var _loop2 = function _loop2() {
	          ...
	          var shareUrl = service.makeUrl({ url: url, title: title, text: text });
	      ...
	      makeResponsive = function makeResponsive() {
	        ...
	        if (!isOverflowing()) {
	          for (var _i = 0; _i < btns.length; _i++) {
	            ...
	            if (_btn.classList.contains('socialshares-btn-icononly')) {
	...
	socialshares.unmount = function () {
	  ...
	  try {
	    for (var _iterator3 = initialButtons[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
	...
	if (socialshares.config.initialize) {
	  (0, _domready2.default)(socialshares.mount);
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _googleplus = __webpack_require__(16);
	...
	var _reddit = __webpack_require__(22);
	
	var _reddit2 = _interopRequireDefault(_reddit);
	
	var _slack = __webpack_require__(25);
	
	var _slack2 = _interopRequireDefault(_slack);
	
	var _tumblr = __webpack_require__(27);
	...
	var _vk = __webpack_require__(31);
	
	var _vk2 = _interopRequireDefault(_vk);
	
	var _more = __webpack_require__(33);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _googleplus = __webpack_require__(17);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _pinterest = __webpack_require__(21);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reddit = __webpack_require__(23);
	
	var _reddit2 = _interopRequireDefault(_reddit);
	
	var _redditColor = __webpack_require__(24);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _slack = __webpack_require__(26);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _tumblr = __webpack_require__(28);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _vk = __webpack_require__(32);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.use = exports.ref = function() {
		if(!(refs++)) {
			...
			dispose = __webpack_require__(38)(content, {"insertAt":"top","singleton":true});
		}
		return exports;
	};
