/*! socialshares v2.0.1 - https://socialshar.es */
...
/***/ function(module, exports, __webpack_require__) {
	...
	socialshares.configure = function (config) {
	  socialshares.config = (0, _objectAssign2.default)({}, config);
	};
	...
	socialshares.mount = function () {
	  ...
	  var _loop = function _loop(i) {
	    ...
	    var _loop2 = function _loop2(_i) {
	      ...
	      var shareUrl = service.makeUrl({ url: url, title: title, text: text, via: via });
